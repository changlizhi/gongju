...
func TestChushihuas(t *testing.T) {
	...
	//log.Println(gongju.Getapppath())
	//log.Println(gongju.Getjichupath())
	//log.Println(gongju.Getchangliangpath())
	//log.Println(gongju.Getjichujsonpath("Shezhi"))
	//log.Println(gongju.Getappjsonpath("Shezhi"))
}
